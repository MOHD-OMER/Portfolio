...
export default function Hero() {
  ...
  const sectionRef = useRef(null); // Renamed for clarity; now only for height measurement
  ...
  // Track global scrollY (no target ref to avoid hydration issue)
  const { scrollY } = useScroll({
    layoutEffect: false, // Retain as safeguard
  });

  // Measure section height client-side (after mount)
  useEffect(() => {
    const updateHeight = () => {
      if (sectionRef.current) {
        setSectionHeight(sectionRef.current.offsetHeight);
      } else {
        // Fallback to viewport height if ref not ready
  ...
  // Calculate progress based on scrollY and measured height
        ...
        >
          ...
          >
            {[
              ...
              {
                icon:
                  "M0 4a2 2 0 012-2h20a2 2 0 012 2v16a2 2 0 01-2 2H2a2 2 0 01-2-2V4zm2-1a1 1 0 00-1 1v.217l10 5.455 10-5.455V4a1 1 0 00-1-1H2zm0 2.434V20a1 1 0 001 1h18a1 1 0 001-1V5.434l-9.668 5.275a.5.5 0 01-.464 0L2 5.434z",
                label: "Email",
              ...
              {
                icon: "M9 4h6v16H9V4zm-4 4h3v12H5V8zm14-2h3v14h-3V6z",
                label: "Resume",
                href: "/resume.pdf",
              },
            ].map((social, index) => (
              ...
              return (
                <motion.div
                  ...
                  style={{
                    ...
                    boxShadow: `0 0 12px ${
                      i % 2 === 0 ? "rgba(59, 130, 246, 1)" : "rgba(139, 92, 246, 0.9)"
                    }`,
                    left: "50%",
                    top: "50%",
